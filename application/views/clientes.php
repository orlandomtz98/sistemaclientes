...
<body id="page-top">
                  ...
                  <tbody>
                    <?php 
                      foreach ($clientes as $cliente) {
                        echo '
                        <tr>
                          <td id="clienteTabla">'.$cliente->nombre.'</td>
                          <td>'.$cliente->direccion.'</td>
                          <td>'.$cliente->celular.'</td>
                          <td><button id="Eliminar" class="btn btn-danger" onclick="EliminarCliente('.$cliente->idClientes.')" >Eliminar</button></td>
                        </tr>
                        ';
                      }
                    ?>
  ...
  <script>
    function EliminarCliente(id){
      var post_url = "<?php echo base_url();?>Controlador_Principal/EliminarCliente";
      var id=id;
      $.ajax({
        type:"POST",
        url:post_url,
