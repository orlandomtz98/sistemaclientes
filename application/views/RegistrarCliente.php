      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="card-body"> 
              <div class="row">
                <div class="col-sm-4"><lable> Nombre:<br> <input type="text" name="nombre" autocomplete="off" required size="30" id="nombre"></lable></div>
                <div class="col-sm-4"><lable> Direccion: <br><input type="text" name="direccion" autocomplete="off" required size="30" id="direccion"></lable></div><br>
                <div class="col-sm-3"><lable> Fecha de nacimiento: <input type="date" name="nacimiento" autocomplete="off" required id="nacimiento"></lable></div><br><br><br><br>
                <div class="col-sm-3"><lable> Edad:<br><input type="text" name="edad" autocomplete="off" required id="edad" readonly></lable></div>
                <div class="col-sm-3"><lable> Telefono:<br><input type="number" name="tel" autocomplete="off" id="tel"></lable></div>
                <div class="col-sm-3"><lable> Celular:<br><input type="number" name="cel" autocomplete="off" id="cel"></lable></div>
                <br><br><br><br>
...
<script>
  $("#Guardar").click(function(){ 
    var post_url = "<?php echo base_url();?>Controlador_Principal/RegistrarCliente";
    $.ajax({
      type: "POST",
      url: post_url,
      data: { 
