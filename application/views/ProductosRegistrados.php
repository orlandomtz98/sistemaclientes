...
<body id="page-top">
                  ...
                  <tbody>
                    <?php 
                      foreach ($productos as $var) {
                        echo '
                        <tr>
                          <td id="productoTabla">'.$var->producto.'</td>
                          <td id="precioTabla">$'.$var->preciounitario.'</td>
                          <td id="botonesTabla"><button id="Eliminar" class="btn btn-danger" onclick="EliminarCliente('.$var->idproductos.')" title="Eliminar"><i class="fas fa-trash"></i></button> <a href="ModificarProducto/'.$var->idproductos.'" class="btn btn-info" title="Modificar"><i class="fas fa-edit"></a></td>
                        </tr>
                        ';
                      }
                    ?>
  ...
  <script>
    function EliminarCliente(id){
      var post_url = "<?php echo base_url();?>Controlador_Principal/EliminarProducto";
      var id=id;
      $.ajax({
        type:"POST",
        url:post_url,
        ...
        success: function(data){
          Swal.fire({
              ...
              showConfirmButton: true
                ...
                if (result.value) {
                  window.location.href = "ProductosRegistrados";
                }
              })
        }
      })
